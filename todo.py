...
# comma was challenging
# creating method for cta was challenging
#  self.task_delete)
# AttributeError: 'MyTodoApp' object has no attribute 'task_staus_change'